...
public class EmployeeDatabase {
    ...
    private final Map<UUID, Employee<UUID>> employees;
    private final List<Employee<UUID>> employeeList;
    ...
    public Employee<UUID> getEmployee(UUID employeeId) throws EmployeeNotFoundException {
        if (employeeId == null) {
            LOGGER.log(Level.SEVERE, "Null employee ID provided");
            throw new IllegalArgumentException("Employee ID cannot be null");
        }
        Employee<UUID> employee = employees.get(employeeId);
        if (employee == null) {
    ...
    public void removeEmployee(UUID employeeId) throws EmployeeNotFoundException {
        ...
        Employee<UUID> employee = employees.remove(employeeId);
        if (employee == null) {
    ...
    public void updateEmployeeDetails(UUID employeeId, String field, Object value) 
        ...
        Employee<UUID> employee = getEmployee(employeeId);
        if (employee == null) {
    ...
    public List<Employee<UUID>> getEmployeesByDepartment(String department) throws InvalidDepartmentException {
        ...
        try {
            List<Employee<UUID>> result = employeeList.stream()
    ...
    public List<Employee<UUID>> searchEmployeesByName(String searchTerm) {
    ...
    public List<Employee<UUID>> getHighPerformingEmployees(double minRating) {
    ...
    public List<Employee<UUID>> getEmployeesInSalaryRange(double minSalary, double maxSalary) 
    ...
    // Sorting Operations
    public List<Employee<UUID>> sortByExperience() {
        if (employeeList.isEmpty()) {
    ...
    public List<Employee<UUID>> sortBySalary() {
        if (employeeList.isEmpty()) {
    ...
    public List<Employee<UUID>> sortByPerformance() {
        if (employeeList.isEmpty()) {
    ...
    public List<Employee<UUID>> getTopPaidEmployees(int count) {
        if (count <= 0) {
    ...
    public double getAverageDepartmentSalary(String department) throws InvalidDepartmentException {
        ...
        List<Employee<UUID>> deptEmployees = getEmployeesByDepartment(department);
