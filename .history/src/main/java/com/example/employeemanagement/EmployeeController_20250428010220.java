...
public class EmployeeController {
    ...
    private final EmployeeDatabase<Integer> employeeDatabase;
    private final ObservableList<Employee<Integer>> employeeList = FXCollections.observableArrayList();

    public EmployeeController(EmployeeDatabase<Integer> employeeDatabase) {
    ...
    public String showUpdateForm(@PathVariable Integer id, Model model) {
        try {
            ...
            LOGGER.log(Level.SEVERE, "Employee not found for update", e);
            return "redirect:/employees";
        }
    }
    ...
    public String deleteEmployee(@PathVariable Integer id) {
        try {
            ...
            LOGGER.log(Level.SEVERE, "Employee not found for deletion", e);
    ...
    public String giveSalaryRaise(@PathVariable Integer id,
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Invalid salary raise percentage", e);
